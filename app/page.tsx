...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Sidebar */}
        <aside className="w-64 flex-shrink-0 border-r border-border bg-card backdrop-blur-xl flex flex-col">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground font-medium">
                  Logistics Message Standardizer
                </p>
              </div>
            </div>
          </div>
          ...
          <nav className="flex-1 px-3 py-4 space-y-1">
            <Button
              ...
              className={cn(
                'w-full justify-start gap-2.5 h-10 font-medium text-sm',
                screen === 'parser' && 'bg-accent text-accent-foreground'
              )}
            ...
            <Button
              ...
              className={cn(
                'w-full justify-start gap-2.5 h-10 font-medium text-sm',
                screen === 'history' && 'bg-accent text-accent-foreground'
              )}
            ...
            >
              ...
              {history.length > 0 && (
                <Badge
                  variant="secondary"
                  className="ml-auto text-[10px] h-5 px-1.5 font-mono"
                >
                  {history.length}
                </Badge>
              )}
            ...
            <div className="flex items-center gap-2">
              <div
                className={cn(
                  ...
                  activeAgentId ? 'bg-orange-500 animate-pulse' : 'bg-emerald-500'
                )}
              />
              <span className="text-xs text-foreground">Shipment Parser</span>
              <Badge
                variant="outline"
                className="ml-auto text-[9px] h-4 px-1 font-mono"
              >
        ...
        <main className="flex-1 flex flex-col min-w-0">
          {/* Header */}
          <header className="h-14 border-b border-border bg-card backdrop-blur-md flex items-center justify-between px-6 flex-shrink-0">
            <div>
